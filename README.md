...
You can include a sample plot generated by the simulation.  
Save your image as `example_plot.png` and upload it to the repository root, then reference it like this:
